...
var VistaUsuario = function(modelo, controlador, elementos) {
    ...
    this.modelo.preguntaVotar.suscribir(function() {
...
VistaUsuario.prototype = {
    ...
    inicializar: function() {
        ...
        elementos.botonAgregar.click(() => {
            ...
            inputCargado? contexto.agregarVotos() : swal({
                title: "",
    ...
    reconstruirGrafico: function(){
        ...
        preguntas.forEach(function(clave){
            ...
            respuestas.forEach (elemento => listaParaGrafico.push([elemento.textoRespuesta,elemento.cantidad]));
    ...
    agregarVotos: function() {
        ...
        $('#preguntas').find('div').each(function() {
            ...
            $('input[name=' + id + ']').prop('checked',false); contexto.controlador.agregarVoto(pregunta,respuestaSeleccionada);
        });
    },
